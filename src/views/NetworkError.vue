<template>
  <div class="h-screen w-screen flex items-center">
    ...
    >
      <div class="max-w-md">
        <h1 class="text-5xl font-dark font-bold">Uh-oh</h1>
        <p class="text-2xl md:text-3xl font-light leading-normal">
          It looks like you're having some network issues, please take a breath
          and
          <a
            href="#"
            @click="$router.go(-1)"
            class="text-vue-green hover:text-vue-green-dark"
            >try again</a
          >.
        </p>
      </div>
